	...
	<div class="col-lg-12">
		...
		<div class="panel panel-default" >
			...
			<div class="panel-body" style="padding-bottom: 4px">
				<form action="{{route('postRigister')}}" method="POST" id="form-create-student" enctype="multipart/form-data">
{!! csrf_field() !!}
						...
						<div class="col-lg-9 col-md-9 col-sm-9">
							...
							<div class="col-md-4">
								<div class="form-group" >
									...
									<input type="text" name="nationnal_card" id="nationnal_card" class="form-control" required>
								</div>
							</div>
							...
							<div class="col-md-8">
								<div class="form-group" >
									...
									<input type="email" name="email" id="phone" class="form-control" required>
								</div>
							</div>
							...
							<div class="form-group form-group-login">
								<table style="margin:0 auto;">
									...
									<tbody>
										<tr>
											<td class="photo">
												{!! Html::image('photo/exaple.jpg',null,['class'=>'student-photo','id'=>'showPhoto']) !!}
